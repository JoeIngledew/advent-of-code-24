...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `112.0ms` | `110.1ms` |
| [Day 2](./src/bin/02.rs) | `136.6µs` | `308.1µs` |
| [Day 3](./src/bin/03.rs) | `151.9µs` | `289.6µs` |
| [Day 4](./src/bin/04.rs) | `4.7ms` | `1.9ms` |
| [Day 5](./src/bin/05.rs) | `866.3µs` | `4.7ms` |
| [Day 6](./src/bin/06.rs) | `318.2µs` | `4.1s` |
| [Day 7](./src/bin/07.rs) | `1.1ms` | `515.9ms` |
| [Day 8](./src/bin/08.rs) | `56.7ms` | `74.2ms` |
| [Day 9](./src/bin/09.rs) | `423.2ms` | `2.2s` |
| [Day 10](./src/bin/10.rs) | `840.1µs` | `512.0µs` |
| [Day 11](./src/bin/11.rs) | `255.9µs` | `8.9ms` |
| [Day 14](./src/bin/14.rs) | `748.2µs` | `-` |
| [Day 17](./src/bin/17.rs) | `2.9µs` | `-` |
| [Day 18](./src/bin/18.rs) | `567.2µs` | `633.1ms` |
